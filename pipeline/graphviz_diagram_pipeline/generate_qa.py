...
from ..prompts.diagram_prompts import GENERATE_DIAGRAM_QA_PROMPT

class GenerateDiagramQA(SuperStep):
    CONFIG_HASH = Hasher.hash([GENERATE_DIAGRAM_QA_PROMPT])
    ...
    @property
    def version(self):
        return hash(GenerateDiagramQA.CONFIG_HASH)
