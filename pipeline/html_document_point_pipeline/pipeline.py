...
from .generate_point import GenerateDocumentPoint


class HTMLDocumentPointPipeline(SuperStep):
    def setup(self):
    ...
    def run(self):
        ...
        # Generate Poin
        generated_point = GenerateDocumentPoint(
            "Generate Point",
            inputs={
    ...
    def version(self):
        return Hasher.hash(
            [
                ...
                GenerateDocumentPoint.CONFIG_HASH,
            ]
        )
